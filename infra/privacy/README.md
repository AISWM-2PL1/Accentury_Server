...
- **광고 사업자 확정** — 1차 배포에 맞춤형 광고를 넣기로 한 2026-09-07 팀 결정(KAN-196 앱,
  KAN-197 웹)에 따라 2항 제3자 제공 표, 4항 국외 이전, 10항 광고에 「확정 후 기재」
  자리표시자가 남아 있다.
...
자리표시자 자체는 테스트로 막지 않는다. 막으면 확정 전 단계의 본문을 커밋할 수 없어 오히려
문서가 코드보다 뒤처진다.
